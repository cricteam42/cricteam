...
require_once("db.php");
if(count($_POST)>0) {
	$sql = "UPDATE odibat set player_team='" . $_POST["player_team"] . "', player_rating='" . $_POST["player_rating"] . "' WHERE player_name='" . $_POST["player_name"] . "'";
	mysqli_query($conn,$sql);
	$message = "Record Modified Successfully";
}
$select_query = "SELECT * FROM odibat WHERE player_name='" . $_GET["player_name"] . "'";

...
if(count($_POST)>0) {
	require_once("db.php");
	$sql = "INSERT INTO testbat(Player_Name,Player_team,Player_Rating) VALUES ('" . $_POST["Player_Name"] . "','" . $_POST["Player_team"] . "','" . $_POST["Player_Rating"] . "')";
...
<div align="right" style="padding-bottom:5px;"><a href="index.php" class="link"><img alt='List' title='List' src='images/list.png' width='15px' height='15px'/> List Player Ranking</a></div>

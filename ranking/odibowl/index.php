<?php
require_once("db.php");
$sql = "SELECT * FROM odibowl ORDER BY player_rating DESC";
...
<div align="right" style="padding-bottom:5px;"><a href="add_user.php" class="link"><img alt='Add' title='Add' src='images/add.png' width='15px' height='15px'/> Add Bowler Ranking</a></div>
<table border="0" cellpadding="10" cellspacing="1" width="500" class="tblListForm">
<tr>
	<th colspan="4">ODI BOWLER RANKING</th>
</tr>
<tr class="listheader">
<td>Sno</td>
<td>Players Name</td>

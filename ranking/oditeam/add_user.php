...
if(count($_POST)>0) {
	require_once("db.php");
	$sql = "INSERT INTO oditeam(Team_Name,Team_Rating,Team_Points) VALUES ('" . $_POST["Team_Name"] . "','" . $_POST["Team_Points"] . "','" . $_POST["Team_Rating"] . "')";
...
<td><input type="text" name="Team_Points" class="txtField"></td>
</tr>

<?php
require_once("db.php");
$sql = "SELECT * FROM testar ORDER BY Player_Rating DESC";
...
<div align="right" style="padding-bottom:5px;"><a href="add_user.php" class="link"><img alt='Add' title='Add' src='images/add.png' width='15px' height='15px'/> Add Ranking</a></div>
<table border="0" cellpadding="10" cellspacing="1" width="500" class="tblListForm">
<tr>
	<th colspan="5">ODI AllRounder RANKING</th>
</tr>
<tr class="listheader">
<td>Sno</td>
<td>Players Name</td>

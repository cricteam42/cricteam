...
<html>
	...
	<nav class="gtco-nav" role="navigation">
		<div class="gtco-container">
			<div class="row">
				<div class="col-xs-2">
					<div id="gtco-logo"><a href="index.html">CricketLiveScore</a></div>
				</div>
				<div class="col-xs-8 text-center menu-1">
					<ul>
						<li class="active"><a href="index.php">Home</a></li>
						<li><a href="about.html">Player Details</a></li>
						<li class="has-dropdown">
							<a href="services.html">Team Ranking</a>
							<ul class="dropdown">
								<li><a href="#">TEST</a></li>
								<li><a href="#">ODI</a></li>
								<li><a href="#">T20</a></li>
						...
						<li class="has-dropdown">
							...
							<ul class="dropdown">
							<li><a href="#">TEST BATSMEN</a></li>
							<li><a href="#">ODI BATSMEN</a></li>
							<li><a href="#">T20 BATSMEN</a></li>
							
							<li><a href="#">TEST BOWLING</a></li>
							<li><a href="#">ODI BOWLING</a></li>
							<li><a href="#">T20 BOWLING</a></li>
								
							<li><a href="#">TEST ALL-ROUNDER</a></li>
							<li><a href="#">ODI ALL-ROUNDER</a></li>
							<li><a href="#">T20 ALL-ROUNDER</a></li>
							</ul>
						</li>
					</ul>
				</div>
				<div class="col-xs-2 text-right hidden-xs menu-2">
					<ul>
						<li class="btn-cta"><a href="../index1.php"><span>Login</span></a></li>
					</ul>
				</div>
			</div>
